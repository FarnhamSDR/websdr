...
var interval_ajax3;
var timeout_idle;
var freqif_fut_timer;  // timer for typing in the frequency field
...
function set_mode(m)      // ...with appropriate filter
{
   switch (m.toUpperCase()) {
      case "USB":
        ...
        document.getElementById("btn-CW-nrw").classList.remove('btn-selected');
        document.getElementById("btn-LSB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-USB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-AM-nrw").classList.remove('btn-selected');
        document.getElementById("btn-FM-nrw").classList.remove('btn-selected');
        break;
      case "USBN":
        setmf("usb", 0.5+(0.091/2),  2.2-(0.091/2));
        document.getElementById("btn-CW").classList.remove('btn-selected');
        document.getElementById("btn-LSB").classList.remove('btn-selected');
        ...
        document.getElementById("btn-CW-nrw").classList.remove('btn-selected');
        document.getElementById("btn-LSB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-USB-nrw").classList.add('btn-selected');
        document.getElementById("btn-AM-nrw").classList.remove('btn-selected');
        document.getElementById("btn-FM-nrw").classList.remove('btn-selected');
        break;
      case "LSB":
        ...
        break;
      case "LSBN":
        setmf("lsb", -2.2+(0.091/2), -0.5-(0.091/2));
        document.getElementById("btn-CW").classList.remove('btn-selected');
        document.getElementById("btn-LSB").classList.remove('btn-selected');
        document.getElementById("btn-USB").classList.remove('btn-selected');
        document.getElementById("btn-AM").classList.remove('btn-selected');
        document.getElementById("btn-FM").classList.remove('btn-selected');
        document.getElementById("btn-CW-nrw").classList.remove('btn-selected');
        document.getElementById("btn-LSB-nrw").classList.add('btn-selected');
        document.getElementById("btn-USB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-AM-nrw").classList.remove('btn-selected');
        document.getElementById("btn-FM-nrw").classList.remove('btn-selected');
        break;
      ...
      case "AMN":
        ...
        document.getElementById("btn-LSB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-USB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-AM-nrw").classList.add('btn-selected');
        document.getElementById("btn-FM-nrw").classList.remove('btn-selected');
        break;
      case "CW":
        setmf("cw", 0.55, 0.95);
      ...
      case "CWN":
        ...
        document.getElementById("btn-AM").classList.remove('btn-selected');
        document.getElementById("btn-FM").classList.remove('btn-selected');
        document.getElementById("btn-CW-nrw").classList.add('btn-selected');
        document.getElementById("btn-LSB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-USB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-AM-nrw").classList.remove('btn-selected');
        document.getElementById("btn-FM-nrw").classList.remove('btn-selected');
      ...
      case "FMN":
        ...
        document.getElementById("btn-USB-nrw").classList.remove('btn-selected');
        document.getElementById("btn-AM-nrw").classList.remove('btn-selected');
        document.getElementById("btn-FM-nrw").classList.add('btn-selected');
        break;
   }
}
